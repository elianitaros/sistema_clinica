            ...
            <ul class="nav nav-tabs">
              <li class="active">	
                <li><a href="#" data-toggle="tab"><i class="fa fa-file-text-o fa-2x" aria-hidden="true"></i> CONSULTA</a></li>		
              	<li><a href="{{url('admin/usuarios')}}" data-toggle="tab"><i class="fa fa-file-text-o fa-2x"></i> ANTECEDENTES</a></li>
...
{{Form::open([  $data,'route' => 'hclinica.hc.store', 'method' => 'post', 'role' => 'form'])}}

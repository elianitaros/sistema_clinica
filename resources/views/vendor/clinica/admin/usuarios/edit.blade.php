...
{{Form::open(['route' => ['admin.usuarios.update', Crypt::encrypt($data->id)], 'method' => 'patch', 'role' => 'form'])}}
@include('vendor.clinica.partial.errors')
<div class="box">
	<div class="box-header">
		<h3 class="box-title"><i class="fa fa-users"></i> EDITAR INFORMACION DE  USUARIO</h3>
	</div>
	<div class="box-body">
		<div class="row">
			...
			<div class="col col-lg-6 col-md-12 col-xs-12">
				<div class="form-group">
					...
					{{ Form::text('username', $data->username, ['class' => 'form-control', 'readonly' => 'true','required' => 'true','minlength' => '6']) }}
				</div>

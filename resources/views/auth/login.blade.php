...
.body{
    ...
    width: auto;
    height: auto;
    background-image: url(http://previews.123rf.com/images/kurhan/kurhan1009/kurhan100900021/7723561-Junges-paar-Patienten-und-Arzt--Lizenzfreie-Bilder.jpg);
...
::-moz-input-placeholder{
  ...
  <div class="body"></div>
        <div class="grad"></div>
        <div class="header">
            <div>Ingresar<span>SHC</span></div>
        </div>
        <br>
        <div class="login">
